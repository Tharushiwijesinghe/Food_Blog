...
import img4 from '../assets/p69.jpg';
...
const Home = () => {
  ...
  return (
    <div className="hero-section bg-dark d-flex " style={{ backgroundImage: `url(${images[currentIndex]})` }}>
      <div className="overlay">
        <div className="content text-center">
          <p className="subtitle">Authentic Sri Lankan Cuisine</p>
          <h1 className="lead display-3 fw-bold">Welcome to <span className="brand-name">LankanTaST</span></h1>
